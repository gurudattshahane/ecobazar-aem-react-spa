# Ecobazar AEM + React SPA project

This project aims to create Ecobazar - Fresh Vegetables and Grocery e-commerce website with dynamic and interactive user interface. 

This project was created using below maven command:
